The first step of kiosk hacking, is to figure out what kind of kiosk you are testing.  Often there is a vendor or product name displayed somewhere on the form fields, or even a product version shown somewhere on the screen, near the top or the bottom.  Sometimes these version numbers are specific enough to pull up the actual product directly, especially if you include mention of what type of product you are looking at, when querying your favorite AI or search tool.
